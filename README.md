...
| Burn reward | `1000e18 >> (totalMinted / 512)`, in base units, at burn time |
...
Difficulty retargets every 8 mints toward 30 seconds per mint, with a maximum 2x adjustment and bounds of 16–24 leading-zero bits. The old difficulty wall and epoch-based exponential growth have been replaced by explicit bounds and a supply cap. This is not protection against professional miners or GPU implementations.
